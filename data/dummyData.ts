...
export let internships: Internship[] = [
    { id: 1, title: 'Frontend Developer Intern', companyId: 101, companyName: 'TechCorp', field: 'Software Engineering', location: 'Jakarta', duration: '3 Months', jobType: JobType.HYBRID, postedDate: getRelativeDate(-5), closingDate: getRelativeDate(25), description: 'Work on our main web application, building new features and improving user experience.', requirements: ['React', 'JavaScript', 'HTML/CSS'] },
    { id: 2, title: 'UI/UX Designer Intern', companyId: 102, companyName: 'InnovateHub', field: 'Design', location: 'Bandung', duration: '6 Months', jobType: JobType.REMOTE, postedDate: getRelativeDate(-2), closingDate: getRelativeDate(30), description: 'Join our design team to create intuitive and beautiful interfaces for our fintech products.', requirements: ['Figma', 'Prototyping', 'User Research'] },
    { id: 3, title: 'Backend Developer Intern', companyId: 101, companyName: 'TechCorp', field: 'Software Engineering', location: 'Jakarta', duration: '3 Months', jobType: JobType.ONSITE, postedDate: getRelativeDate(-10), closingDate: getRelativeDate(10), description: 'Help build and maintain our microservices architecture using Go.', requirements: ['Go', 'REST APIs', 'SQL'] },
    { id: 4, title: 'Digital Marketing Intern', companyId: 102, companyName: 'InnovateHub', field: 'Marketing', location: 'Bandung', duration: '3 Months', jobType: JobType.HYBRID, postedDate: getRelativeDate(-1), closingDate: getRelativeDate(20), description: 'Assist in creating and managing social media campaigns.', requirements: ['Social Media', 'Copywriting', 'Canva'] },
];

export let applications: Application[] = [
    { 
        id: 1, internshipId: 1, studentId: 1, status: ApplicationStatus.APPLIED, applicationDate: getRelativeDate(-2), 
        ...
        reasonForApplying: 'Sangat tertarik dengan pengembangan frontend di TechCorp.', internshipStartDate: getRelativeDate(20), internshipEndDate: getRelativeDate(110),
        preferredWorkType: 'Hybrid', dataAuthenticityConfirmation: true, dataProcessingConsent: true, eSignature: 'John Doe'
    },
    { 
        id: 2, internshipId: 2, studentId: 2, status: ApplicationStatus.ACCEPTED, applicationDate: getRelativeDate(-10),
        ...
        reasonForApplying: 'Ingin berkontribusi pada desain produk di InnovateHub.', internshipStartDate: getRelativeDate(5), internshipEndDate: getRelativeDate(180),
        preferredWorkType: 'WFH', dataAuthenticityConfirmation: true, dataProcessingConsent: true, eSignature: 'Jane Smith'
    },
    { 
        id: 3, internshipId: 1, studentId: 2, status: ApplicationStatus.REJECTED, applicationDate: getRelativeDate(-15),
        fullName: 'Jane Smith', studentIdNumber: '987654321', major: 'Information Systems', university: 'Institut Teknologi Bandung',
        currentSemester: 8, gender: 'Perempuan', dateOfBirth: '2002-11-20', phoneNumber: '081234567892', activeEmail: 'janesmith@email.com',
        address: 'Jl. Asia Afrika No. 10, Bandung', cvFileName: 'JaneSmith_CV.pdf', transcriptFileName: 'JaneSmith_Transcript.pdf',
        gpa: 3.9, mainSkills: ['UI/UX Design', 'Figma'], softwareTools: ['Figma', 'Adobe XD'], languages: ['Indonesia', 'English'],
        reasonForApplying: 'Mencoba peruntungan di bidang lain.', internshipStartDate: getRelativeDate(20), internshipEndDate: getRelativeDate(110),
